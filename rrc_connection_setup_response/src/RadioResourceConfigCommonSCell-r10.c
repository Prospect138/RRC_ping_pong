...
asn_TYPE_member_t asn_MBR_RadioResourceConfigCommonSCell_r10_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigCommonSCell_r10, ul_Configuration_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigCommonSCell_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_33,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommonSCell_r10, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_35,
		0,
...
static const int asn_MAP_RadioResourceConfigCommonSCell_r10_oms_1[] = { 1, 2, 3 };
