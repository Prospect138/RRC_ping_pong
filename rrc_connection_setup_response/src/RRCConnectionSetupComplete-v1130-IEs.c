...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_4 = {
	sizeof(struct RRCConnectionSetupComplete_v1130_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionSetupComplete_v1130_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
