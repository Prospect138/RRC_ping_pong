...
static int
memb_systemInfomationBlockType1Dedicated_r11_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_systemInfomationBlockType1Dedicated_r11_constr_2 CC_NOTUSED = {
